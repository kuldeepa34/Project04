           ...
           <input type="hidden" name="uri" value="<%=uri%>">
          	 ...
          	 <table align="center" style="margin-left: 40%">
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" placeholder="Enter Password" size=30 value="<%=DataUtility.getStringData(bean.getPassword())%>"><font color="red"> <%=ServletUtility.getErrorMessage("password", request)%></font></td>
                </tr>
