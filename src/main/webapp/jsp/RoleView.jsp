...
<jsp:useBean id="bean" class="in.co.sunrays.proj4.bean.RoleBean" scope="request"/>
        <center>
		...
		%>
            ...
            <table align="center" style="margin-left: 40%">
                <tr>
                    ...
                    <td>
                    <input type="text" size="19" name="name" placeholder="Name" value="<%=DataUtility.getStringData(bean.getName())%>">
                ...
                <tr>
                    ...
                    <td>
                   <textarea rows="4" cols="20" name="description" placeholder="Description"><%=DataUtility.getStringData(bean.getDescription())%></textarea><font color="red">
